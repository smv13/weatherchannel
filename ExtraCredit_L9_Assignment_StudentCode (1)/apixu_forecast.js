    ...
    Activity 1:  Add your APIXU API KEY in the code below.  This KEY can be retreived by visiting the 
                 ...
                 (https://www.apixu.com)
                  ...
                  Use the following code as an example:  
                     ...
                     url: 'https://api.apixu.com/v1/forecast.json?key=9494b15cb2214caa974233814160812',
        ...
        $(document).ready(function(){
           $(':button').click(function(){
                ...
                .done(function(json){
                    ...
                    $('#Day3Low').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day3High').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day4Low').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day4High').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day5Low').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day5High').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day6Low').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day6High').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day7Low').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day7High').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day8Low').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day8High').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day9Low').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day9High').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
                    $('#Day10Low').html("<center>" + json.forecast.forecastday[1].day.maxtemp_f + "</center>");  
